...
import { Mail, MapPin, Phone, Send, Clock, Calendar, MessageSquare, Globe } from 'lucide-react'
            ...
            <main className="max-w-7xl mx-auto px-6 py-24 relative z-10">
                <section className="text-center mb-20">
                    <div className="inline-flex items-center bg-gray-800/50 backdrop-blur-md px-6 py-3 rounded-full border border-gray-700 mb-6">
                        ...
                        <span className="text-cyan-400 text-sm font-medium">Kontakt aufnehmen</span>
                    </div>
                    <h1 className="text-5xl md:text-7xl font-bold mb-6">
                        <ReactTyped
                            className="bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-600 bg-clip-text text-transparent"
                            strings={["Lass uns in Kontakt treten"]}
                            typeSpeed={40}
                            backSpeed={100}
                            loop
                        />
                    ...
                    <p className="text-xl text-gray-300 max-w-2xl mx-auto">
                        Ich freue mich auf Ihre Nachricht! Ob Projektanfrage, Zusammenarbeit oder einfach nur ein nettes Hallo - ich antworte innerhalb von 24 Stunden.
                    </p>
                </section>
                    ...
                    <div className="bg-gradient-to-br from-blue-900/50 to-gray-900/50 p-8 rounded-2xl border border-blue-800/50 backdrop-blur-md hover:border-blue-500/50 transition-all duration-300 group">
                        ...
                        <div className="pl-14 mt-4">
                            <p className="text-sm text-blue-300 mb-3">
                                Für schnelle Anfragen nutzen Sie gerne auch:
                            </p>
                            <a href="https://github.com/Mehmet-Prim" className="w-8 h-8 bg-blue-900/30 rounded-full flex items-center justify-center hover:bg-blue-900/50 transition-all">
